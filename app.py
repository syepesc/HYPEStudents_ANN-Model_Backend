...
def predict():
	...
	if prediction < .5:
		return {"prediction":str(prediction), "graphs":["academic performance vs failure.png", "first year survival vs failure.png", "high school marks vs failure.png"]} # '%.2f % to fail. well done! keep hard working'
	else:
		return {"prediction":str(prediction), "graphs":["academic performance vs failure.png", "first year survival vs failure.png", "high school marks vs failure.png"]} # '%.2f % to fail. well done! keep hard working'
		# return {"prediction":str(prediction), "graphs":[]} # '%.2f % to fail.'
