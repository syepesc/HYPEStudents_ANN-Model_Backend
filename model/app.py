...
pred_sample = [{'INTAKE TERM CODE': 2020, 'ADMIT TERM CODE': 2020, 'INTAKE COLLEGE EXPERIENCE': 'New to College', 'PRIMARY PROGRAM CODE': 9111, 'SCHOOL CODE': 'CH',
...
sample = pd.DataFrame(pred_sample)
