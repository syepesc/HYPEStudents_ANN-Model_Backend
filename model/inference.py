import pandas as pd, shelve, catboost as cb
...
deserializer = shelve.open('encoder')
label_encoders = deserializer['label encoder']
...
print(model.predict_proba(sample)[:, 1][0])